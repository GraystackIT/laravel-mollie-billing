...
new class extends Component {
    ...
    private const ALLOWED_SORTS = ['id', 'tax_country_user', 'tax_country_payment', 'created_at'];
...
<div class="space-y-6">
    <x-mollie-billing::admin.page-header
        ...
        subtitle="Cases where the user's declared tax country differs from the country derived from their payment method."
    />
